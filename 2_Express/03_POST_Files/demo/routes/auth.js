...
// Global var to hold username to use as filename prefix
var fileNamePrefix = '';
...
var storage = multer.diskStorage({
    ...
    filename: function(req, file, cb) {
        cb(null, `${fileNamePrefix}_${file.originalname}`)
    }
});
    ...
    if (username) {
        ...
        try {
            if (req.file.filename) {
                imageurl = `/uploads/${fileNamePrefix}_${req.file.originalname}`;
            }
        } catch (e) {
